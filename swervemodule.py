...
class SwerveModule:
    def __init__(
        ...
        self.drivingPIDController: rev.SparkClosedLoopController = self.drivingSparkMax.getClosedLoopController()
        self.turningPIDController: rev.SparkClosedLoopController = self.turningSparkMax.getClosedLoopController()
